                ...
                <Row>
                    <Col>
                        ...
                        </Row>
                        {
                            ...
                            Array.from(documents.documents).length > 0 &&
                            <Row>
                                <h5>Related documents</h5>
                                <ul>
                                    {
                                        Array.from(documents.documents).map((entry: any) => {
                                            return <li>
                                                <a href={Api.apiAddress + 'api/customer/download/' + documents.clientId + '/' + entry.documentId}>{entry.title}</a>
                                            </li>
                                        })
                                    }
                                </ul>
