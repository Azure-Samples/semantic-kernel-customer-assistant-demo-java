...
public class CustomerController {
                            ...
                            .concatMap(note -> {
                                return semanticKernelProvider
                                        ...
                                        .flatMap(customerInfo -> {
                                            return collection.upsertAsync(customerInfo, null);
                                        });
                            });
                })
                .last()
    ...
    public Mono<QueryResult> addCustomerFact(Customer customer, String statement) {
        ...
        return saveCustomerFacts(customer)
                .map(facts -> new QueryResult(facts, new Documents(customer.getUid(), List.of())));
    }
    ...
    public Mono<QueryResult> buildPlan(Customer customer, ChatHistory chatHistory) {
        ...
        return kernel
                ...
                .map(it -> new QueryResult(it, customer.getUid()));
